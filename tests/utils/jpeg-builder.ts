...
export function toUint16(n: number): number {
...
export function toUint32(n: number): number {
  ...
  return ((x % TWO32) + TWO32) % TWO32;
}

export function be16(n: number): U8 {
  const u = new Uint8Array(2);
  new DataView(u.buffer, u.byteOffset, 2).setUint16(0, toUint16(n), false);
  return u;
}

export function le16(n: number): U8 {
  const u = new Uint8Array(2);
  new DataView(u.buffer, u.byteOffset, 2).setUint16(0, toUint16(n), true);
  return u;
}

export function le32(n: number): U8 {
  const u = new Uint8Array(4);
  new DataView(u.buffer, u.byteOffset, 4).setUint32(0, toUint32(n), true);
  return u;
}

// (optional) big-endian 32 if you ever need it:
export function be32(n: number): U8 {
  const u = new Uint8Array(4);
  new DataView(u.buffer, u.byteOffset, 4).setUint32(0, toUint32(n), false);
  return u;
}
